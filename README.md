...
File Management:-
	...
	Linux:-
		...
		cat /proc/self/cmdline //view what are the commands issued by users
...
reg query HKLM\SOFTWARE\Policies\Microsoft\Windows\Installer /v AlwaysInstallElevated //check if you can install msi package as system
